        ...
        public static async Task Run([EventGridTrigger]EventGridEvent eventGridEvent, ILogger log)
        {
            ...
            try
            {
                ...
                if (eventGridEvent != null && eventGridEvent.Data != null)
                {
                    ...
                    var avABI = @"[{""inputs"": [],""stateMutability"": ""nonpayable"",""type"": ""constructor""},{""inputs"": [],""name"": ""getTempThresholds"",""outputs"": [{""internalType"": ""uint256"",""name"": """",""type"": ""uint256""},{""internalType"": ""uint256"",""name"": """",""type"": ""uint256""}],""stateMutability"": ""view"",""type"": ""function""}]";
                    ...
                    /*if (functionalState == "Functional")
                    {
                        // Invoke vehicle contract method to update vehicle temperature
                        var vehicleABI = @"[{""anonymous"": false,""inputs"":[{""indexed"": false,""internalType"": ""address"",""name"": ""setter"",""type"": ""address""},{""indexed"": false,""internalType"": ""int256"",""name"": ""temperature"",""type"": ""int256""}],""name"": ""TemperatureSet"",""type"": ""event""},{""inputs"": [],""name"": ""getTemp"",""outputs"": [{""internalType"": ""int256"",""name"": """",""type"": ""int256""}],""stateMutability"": ""view"",""type"": ""function""},{""inputs"": [{""internalType"": ""int256"",""name"": ""_temp"",""type"": ""int256""}],""name"": ""setTemp"",""outputs"": [],""stateMutability"": ""nonpayable"",""type"": ""function""}]";

                        // Initialize AV Contract
                        var vehicleContract = web3.Eth.GetContract(vehicleABI, selfAddress);

                        var setTempFunction = contract.GetFunction("setTemp");
                        //Invoke set event from contract
                        var trxHash = await setTempFunction.SendTransactionAsync(selfAddress, deviceCurrentTemperature);

                        log.LogInformation($"Temperature Updated: {trxHash}");
                    }*/
